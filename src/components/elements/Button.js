...
export default function Button({children, className, color, theme}) {
  ...
  switch (theme) {
    case 'small':
      return (
        <div>
            <button className={` ${className} ${background}  px-4 py-2 uppercase shadow-xl text-white text-zs font-medium animate`}> 
                {children}
            </button>
        </div>
      ); 
      ...
      return (
        <div>
            <button className={` ${className} ${background}  px-8 py-4 uppercase shadow-xl text-white tracking-widest text-base font-medium animate`}> 
                {children}
            </button>
        </div>
      ); 
